  ...
  <a-layout class="components-layout">
      ...
      <div class="components-header-right">
        ...
        <div class="components-header-system">
          ...
          <iframe
            ...
            scrolling="no"
            hspace="0"
            src="https://i.tianqi.com/?c=code&a=getcode&color=%2300e4fd&id=12&num=1&py=nantong&icon=1"
          ></iframe>
          <div class="components-header-user">
            <a-avatar
              class="components-header-img"
              :size="51"
              :src="avatar"
              @click="visible = true"
            />
    ...
    <a-layout class="warp">
      <a-layout-sider v-show="fold" width="200" class="components-sider">
        ...
        <template>
          <a-menu class="components-menu"theme="dark"mode="inline">
            <a-menu-item @click="menuClick">首页</a-menu-item>
          </a-menu>
        </template>
      </a-layout-sider>
      <a-layout style="padding: 0 24px 24px 12px">
        <div style="display: flex;align-items: center;">
          <a-button
            ...
            type="link"
            ghost
            :icon="fold ? 'menu-fold' : 'menu-unfold'"
            @click="foldChange"
          />
          <a-breadcrumb
            style="margin: 16px 0;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"
          >
