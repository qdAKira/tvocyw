<template>
	<div class="media-warp" :style="{right: isMove ? '-505px' : ''}">
		<div class="media-warp-title" @click="myMoveIn">当月排水次数统计</div>
			...
			<div class="table">
				...
				<div class="table-tbody">
					<div class="table-tr" v-for="(item,index) in list">
						...
						<div class="table-td number">{{item.exportNumber}}</div>
					</div>
...
<style scoped lang="less">
	.media-warp {
		...
		width: 490px;
		height: 440px;
		background: url(../../../../static/image/drainage-state.png) no-repeat left bottom / 100% 423px;
		transition: right 1s;
