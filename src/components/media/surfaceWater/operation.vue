<template>
	<div class="media-warp" :style="{left: isMove ? '-505px' : ''}">
		...
		<div class="media-warp-title active" :style="{opacity: opacity}" v-show="isMove" @click="myMoveOut">运行情况
		</div>
...
<style scoped lang="less">
	.media-warp {
		...
		width: 505px;
		height: 315px;
		background: url(../../../../static/image/yxqk.png) no-repeat left bottom / 100% 295px;
		transition: left 1s;
